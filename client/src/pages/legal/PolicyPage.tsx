  ...
  return (
    <div className="page-enter mx-auto max-w-3xl px-6 py-16 lg:px-10">
      ...
      <div className="mt-12 flex flex-wrap gap-4 border-t border-theme-border pt-8 text-[10px] uppercase tracking-widest">
        <Link to="/privacy" className="text-brand-muted hover:text-brand-white">Privacy</Link>
        <Link to="/terms" className="text-brand-muted hover:text-brand-white">Terms</Link>
        <Link to="/cookies" className="text-brand-muted hover:text-brand-white">Cookies</Link>
